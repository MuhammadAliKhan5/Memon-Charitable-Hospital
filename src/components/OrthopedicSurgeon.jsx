...
import { Phone, Calendar, Clock, User, Bone } from 'lucide-react';
import AOS from 'aos';
...
const OrthopedicSurgeon = () => {
  ...
  const doctors = [
    { name: "Dr. Syed Muhammad Ali", day: "Sunday", timing: "2pm to 4pm", contact: "0300-9371495" },
    { name: "Dr. Rashid Qayoom", day: "Mon, Tue, Thu, Sat", timing: "3pm to 5pm", contact: "0333-2435411" },
    { name: "Dr. Zeeshan Arbab", day: "Friday", timing: "2pm to 5pm", contact: "0334-3023990" }
  ];

  return (
    <div className="bg-white min-h-screen">
      <header className="relative h-[500px] bg-gray-900 flex items-center justify-center overflow-hidden">
        <img src="/slider2.jpg" className="absolute inset-0 w-full h-full object-cover opacity-50 scale-105" alt="Orthopedics" />
        ...
        <div className="relative z-10 text-center text-white px-4">
          <div className="flex justify-center mb-6" data-aos="zoom-in">
             <div className="bg-[#c2272c] p-4 rounded-full shadow-lg"><Bone size={48} /></div>
          </div>
          <h1 className="text-5xl md:text-6xl font-black mb-6 tracking-tight" data-aos="fade-down">Orthopedic Surgeon</h1>
      ...
      <section className="py-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center" data-aos="fade-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 uppercase tracking-widest text-sm">Bone & Joint Excellence</h2>
          <p className="text-gray-600 text-lg leading-relaxed italic">
            Specializing in the musculoskeletal system, our surgeons provide comprehensive care for bones, joints, ligaments, and tendons. 
            Whether treating sports injuries, degenerative conditions like arthritis, or complex fractures, we utilize modern 
            surgical and non-surgical techniques to restore your mobility and get you back to an active lifestyle.
          </p>
        </div>
      </section>
