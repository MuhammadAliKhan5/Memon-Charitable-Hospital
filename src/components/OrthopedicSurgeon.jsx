...
const OrthopedicSurgeon = () => {
  ...
  const doctors = [
    ...
    { name: "Dr. Rashid Qayoom", day: "Mon, Tue, Thu, Sat", timing: "03:pm to 5pm", contact: "0333-2435411" },
    ...
    <div className="bg-white min-h-screen">
      <header className="relative h-[350px] bg-gray-900 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4" data-aos="fade-up">Orthopedic Surgeon</h1>
