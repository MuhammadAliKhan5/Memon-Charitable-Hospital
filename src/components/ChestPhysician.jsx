...
import { Phone, Calendar, Clock, User, Wind } from 'lucide-react';
import AOS from 'aos';
...
const ChestPhysician = () => {
  ...
  const doctors = [
    { name: "Dr. Imran Memon", day: "Tuesday", timing: "6pm to 8pm", contact: "0333-1234567" }
  ];
    ...
    <div className="bg-white min-h-screen">
      <header className="relative h-[500px] bg-gray-900 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <div className="flex justify-center mb-6" data-aos="zoom-in">
             <div className="bg-[#c2272c] p-4 rounded-full shadow-lg"><Wind size={48} /></div>
          </div>
          <h1 className="text-5xl md:text-6xl font-black mb-6 tracking-tight" data-aos="fade-down">Chest Physician</h1>
      ...
      <section className="py-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center" data-aos="fade-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 uppercase tracking-widest text-sm">Respiratory Health Excellence</h2>
          <p className="text-gray-600 text-lg leading-relaxed italic">
            Our Pulmonary and Chest department specializes in the diagnosis and treatment of conditions affecting the respiratory system. 
            From chronic asthma and COPD to complex lung infections, our specialists provide comprehensive diagnostic evaluations and 
            advanced treatment plans to help you breathe easier and maintain optimal lung health.
          </p>
        </div>
      </section>
