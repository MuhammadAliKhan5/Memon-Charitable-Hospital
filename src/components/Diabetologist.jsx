...
const Diabetologist = () => {
  ...
  const doctors = [
    { name: "Dr. Abdul Hafeez", day: "Monday, Wednesday", timing: "7pm to 9pm", contact: "0300-3012399" },
    { name: "Dr. Sameer Qureshi", day: "Friday", timing: "5pm to 7pm", contact: "0333-2424242" }
  ];
    ...
    <div className="bg-white min-h-screen">
      <header className="relative h-[500px] bg-gray-900 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <h1 className="text-5xl md:text-6xl font-black mb-6 tracking-tight" data-aos="fade-down">Diabetologist</h1>
      ...
      <section className="py-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center" data-aos="fade-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 uppercase tracking-widest text-sm">Managing Your Blood Sugar</h2>
          <p className="text-gray-600 text-lg leading-relaxed italic">
            Our Diabetes and Endocrinology clinic provides expert care for patients living with Type 1 and Type 2 diabetes. 
            We focus on advanced management plans, including glucose monitoring, dietary counseling, and lifestyle modifications 
            to prevent complications and improve your overall quality of life through comprehensive metabolic care.
          </p>
        </div>
      </section>
