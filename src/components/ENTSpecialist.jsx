...
import { Phone, Calendar, Clock, User, Ear } from 'lucide-react';
import AOS from 'aos';
  ...
  return (
    <div className="bg-white min-h-screen">
      <header className="relative h-[500px] bg-gray-900 flex items-center justify-center overflow-hidden">
        <img src="/slider2.jpg" className="absolute inset-0 w-full h-full object-cover opacity-50 scale-105" alt="ENT Specialist" />
        ...
        <div className="relative z-10 text-center text-white px-4">
          <div className="flex justify-center mb-6" data-aos="zoom-in">
             <div className="bg-[#c2272c] p-4 rounded-full shadow-lg"><Ear size={48} /></div>
          </div>
          <h1 className="text-5xl md:text-6xl font-black mb-6 tracking-tight" data-aos="fade-down">ENT Specialist</h1>
      ...
      <section className="py-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center" data-aos="fade-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 uppercase tracking-widest text-sm">Otolaryngology Services</h2>
          <p className="text-gray-600 text-lg leading-relaxed italic">
            Our ENT department provides specialized care for conditions related to the ear, nose, and throat. 
            We offer expert treatment for hearing loss, sinus disorders, throat infections, and complex 
            head and neck issues. Our specialists use the latest diagnostic technology to ensure precise 
        ...
        {doctors.map((doc, i) => (
          <div key={i} className="p-8 bg-white border border-gray-100 rounded-[2.5rem] hover:shadow-2xl transition-all duration-300 group hover:-translate-y-2 hover:border-[#c2272c]" data-aos="fade-up">
            ...
            <div className="space-y-4 mb-10 text-gray-600 font-medium">
              <p className="flex items-center gap-3 text-lg"><Calendar size={20} className="text-[#c2272c]"/> {doc.day}</p>
              <p className="flex items-center gap-3 text-lg"><Clock size={20} className="text-[#c2272c]"/> {doc.timing}</p>
            </div>
