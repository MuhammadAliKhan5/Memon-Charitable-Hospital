  ...
  return (
    <div className="bg-white min-h-screen">
      <header className="relative h-[500px] bg-gray-900 flex items-center justify-center overflow-hidden">
        <img src="/slider2.jpg" className="absolute inset-0 w-full h-full object-cover opacity-50 scale-105" alt="Plastic Surgery" />
        ...
        <div className="relative z-10 text-center text-white px-4">
          <div className="flex justify-center mb-6" data-aos="zoom-in">
             <div className="bg-[#c2272c] p-4 rounded-full shadow-lg"><Scissors size={48} /></div>
          </div>
          <h1 className="text-5xl md:text-6xl font-black mb-6 tracking-tight" data-aos="fade-down">Plastic Surgeon</h1>
      ...
      <section className="py-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-6 text-center" data-aos="fade-up">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 uppercase tracking-widest text-sm">Precision & Reconstruction</h2>
          <p className="text-gray-600 text-lg leading-relaxed italic">
            Our Plastic Surgery department combines surgical expertise with aesthetic precision. 
            We offer a wide range of services including reconstructive surgery for trauma or congenital issues, 
            as well as cosmetic procedures designed to enhance confidence and restore form and function 
